...
void IncoherentL1::snapshotCache(const std::string& dir, const std::string& cacheName) {
...
void IncoherentL1::snapshotLoadCache(const std::string& dir, const std::string& cacheName) {
    std::string filename = dir + "/" + cacheName;
