...
#define FOREACH_FUNCTION(NAME) \
    ...
    NAME(SYSCALL_OP_GETRANDOM)\
    NAME(SYSCALL_OP_UNLINKAT)\
    NAME(SYSCALL_OP_UNLINK)\
    NAME(SYSCALL_OP_SET_TID_ADDRESS)\
    NAME(SYSCALL_OP_SET_ROBUST_LIST)\
    NAME(SYSCALL_OP_PRLIMIT)\
    NAME(SYSCALL_OP_HWPROBE)\
    NAME(SYSCALL_OP_RSEQ)\
    NAME(NUM_SYSCALLS)\
